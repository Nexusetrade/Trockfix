            ...
            <div className="bg-gray-900 text-white p-10 rounded-3xl mt-20 shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-8 text-gray-300">
                  ...
                  Wasserschäden Gold wert. Neben Wasserschadensanierung & Bautrocknung Friedrichshofen helfen wir auch bei allen anderen Herausforderungen rund um Wasser und Feuchtigkeit.
                </p>
